...
table = Table(title="By [yellow]✞ SkNot[/yellow] and [#7115bd]Aniko")
table.add_column("[green]Raiding", justify="right", style="white", no_wrap=True)
table.add_column("[green]TokenChooser", style="white")
table.add_column("[green]Others", justify="right", style="white")
table.add_row("Spammer [[red]1[/red]]","[[red]7[/red]] About/Status Change","MassReport [[red]13[/red]]")
table.add_row("DM Spammer [[red]2[/red]]","[[red]8[/red]] Joiner","Server Nuker [[red]14[/red]]")
table.add_row("Friend Spammer [[red]3[/red]]","[[red]9[/red]] Leaver","Account Nuker [[red]15[/red]]")
table.add_row("Reaction Spam [[red]4[/red]]","[[red]10[/red]] TokenChecker","Token BruteForce [[red]16[/red]]")
table.add_row("Webhook Spammer [[red]5[/red]]","[[red]11[/red]] Token Onliner","About [[red]17[/red]]")
table.add_row("Typing Spammer [[red]6[/red]]","[[red]12[/red]] HypeSquad Joiner","Exit [[red]18[/red]]")

#The Tool is a source Code
#Made By ✞ SkNot#1233 and Aniko#2688
...
def main():
    ...
    def spammer():
        ...
        choice = int(input(f'[{Fore.RED+getuser()+Fore.RESET}@Shodan] Choose > '))
        ...
        if choice == 1:
            ...
            time.sleep(5)
            exit = input(f'[yellow]Press any key...')
            clear = lambda: os.system('cls')
            exit = clear()
            exit = spammer()
    ...
    {Fore.BLUE}[4] {Fore.BLUE}Leave The HypeSquad''')
        ...
        if choice == 15:
            ...
            print(f'''{Fore.WHITE}[{Fore.RED}1{Fore.WHITE}]{Fore.WHITE} Server spam
    {Fore.WHITE}[{Fore.RED}2{Fore.WHITE}]{Fore.WHITE} Remove all friends
    {Fore.WHITE}[{Fore.RED}3{Fore.WHITE}]{Fore.WHITE} Block all friends
    {Fore.WHITE}[{Fore.RED}4{Fore.WHITE}]{Fore.WHITE} Spam settings
    {Fore.WHITE}[{Fore.RED}5{Fore.WHITE}]{Fore.WHITE} Leave all servers
    {Fore.WHITE}[{Fore.RED}6{Fore.WHITE}]{Fore.WHITE} Close all DMs
    {Fore.WHITE}[{Fore.RED}7{Fore.WHITE}]{Fore.WHITE} Send mass DM
    {Fore.WHITE}[{Fore.RED}8{Fore.WHITE}]{Fore.WHITE} Delete all her Servers''')
        ...
        if choice == 17:
            ...
            console.print(Panel.fit(f'''[green]Hey, questo tool e stato creato da Shodan V.1, per precisare da [cyan]✞ SkNot#1233[/cyan] e [purple]Aniko#2688[/purple] (CLI Inteface), per supporto o bugs reportarli sul discord! https://discord.gg/dj6RHtPxxz'''),justify="center")
            exit = console.input('[yellow]Press any key...')
            clear = lambda: os.system('cls')
            exit = clear()
            exit = spammer()
